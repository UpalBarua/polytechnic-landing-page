    ...
    <InView>
      {({ ref, inView }) => (
        <section
          ref={ref}
          className={cn(
            "bg-[url('/images/slider1.jpg')] bg-cover bg-center text-background/90 transition-opacity duration-700",
          ...
          <div className="flex flex-col items-start justify-center px-4 py-16 backdrop-brightness-[0.25] sm:items-center md:py-28">
            <div className="pb-8 lg:pb-10">
              ...
              <p className="max-w-lg leading-relaxed text-background/60 sm:mx-auto sm:text-center">
                দারিদ্রদ্র্য বিমোচন, কর্মসংস্থানের সুযোগ সৃষ্টি,
                আত্ম-কর্মসংস্থান, বেকারত্ব, ক্ষুধা ও দুর্নীতিমুক্ত সমৃদ্ধ
                বাংলাদেশ গড়া, উদ্যোক্তা, উন্নয়ন ও উৎপাদনশীলতা বৃদ্ধিতে কারিগরি ও
                বৃত্তিমূলক শিক্ষার ভূমিকা
              </p>
            </div>
