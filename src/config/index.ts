...
export const mainNavLinks = [
  ...
  {
    route: "https://bdjobs.com/default.asp/",
...
export const campusInfo = {
  ...
  address:
    "৮১১/এ, এইচ. আর কমপ্লেক্স, বহরদার বাড়ি পুকুরের পশ্চিম পার্শ্বে, শাহ আমানত সেতু সংযোগ সড়ক, বহরদারহাট, চট্রগ্রাম। ",
